...
#d2 = [random.choice([2, 3, 4, 5, 6, 7, 8,9,10,12,14,16,15,18]) for i in range(6) ]
#d2 = [random.choice([2.5, 4.5, 5, 7.5, 9]) for i in range(4) ]
...
if(result1 < result2):
    lists.append( (d2, result1, result2))


print("the lists, ", lists)
