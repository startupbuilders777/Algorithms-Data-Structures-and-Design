...
Do coding signal practice quick algo review: 



AKUNA QUANT:
PRACTICE 2S complements, converting between the 2

FIGURE OUT ALL THE ways to use binary operators to find powers of 2 besides 
n & ( n -1 ) == 0
...
First of all, I participated the monthly challange April & May, so this really helped me to build a habbit of daily problem solving
